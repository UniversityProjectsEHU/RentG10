            ...
            <div>
                ...
                <form name="formcerrarsesion" action="cerrarsesion" id="formcerrarsesion" method="get">
                    ...
                    <form id="formconsulta" method="get" action="controladorConsultaAdminCliente">
                        <p>Email: <input type="email" name="emailcliente" id="emailcliente" />
                        <p><br/></p>
                        <p><input id="botonenviar" type="submit" value="Enviar" />
                    </form>
                </section> 
                <h1>Estas son las reservas del cliente indicado:</h1>
                <table border=1>
                    ...
                    <%
                        ...
                        Connection con = BD.getConexion();
                        try {
                            String elemail = (String) session.getAttribute("emailconsulta");
                            set = con.createStatement();
                            rs = set.executeQuery("SELECT * FROM reservar where email=" + "'" + elemail + "'");
                            while (rs.next()) {
                                int id = rs.getInt("id");
